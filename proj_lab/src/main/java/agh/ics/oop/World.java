...
public class World {
    public static void main(String[] args){
        try {
            ...
            ArrayList<Genome> genomes1 = new ArrayList<>(List.of(new Genome(List.of(0,0,0)),new Genome(List.of(1,2,3)),new Genome(List.of(2,2,2))));
            GrassField map1 = new GrassField(7,1);
            map1.addObserver(observer);
            Simulation simulation1 = new Simulation(genomes1, positions1, map1);
